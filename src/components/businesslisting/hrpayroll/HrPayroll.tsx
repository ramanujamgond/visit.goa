      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex-shrink-1 flex-grow-1 basis-1/2">
          <div className="text-2xl font-bold mb-6">
            Efficient <span className="text-[#685CF1]">HR</span> and{" "}
            <span className="text-[#685CF1]">Payroll </span>
            Outsourcing Services for{" "}
            <span className="text-[#685CF1]">Streamlined Operations</span>
          </div>
          ...
          <div className="text-sm font-normal text-[#7A7A7A] mb-6 text-justify">
            ...
            payroll management with VisitGoa.
          </div>
