...
const Footer = () => {
  const year = new Date();
  return (
    <div className="absolute w-[100%] left-0 right-0 bottom-0 pb-4 bg-[#1f1f1f]">
      <div className="container flex justify-between">
        <div className="my-4">
          <div className="text-2xl font-bold text-white my-6">Download App</div>
